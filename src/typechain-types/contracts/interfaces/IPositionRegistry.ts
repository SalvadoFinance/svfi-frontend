...
export interface IPositionRegistryInterface extends utils.Interface {
  functions: {
...
export interface IPositionRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPositionRegistryInterface;
